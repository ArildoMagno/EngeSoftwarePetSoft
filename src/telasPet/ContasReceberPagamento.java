 ...
 * @author Atlas
 */
public class ContasReceberPagamento extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContasReceberPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
