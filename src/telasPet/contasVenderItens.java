 ...
 * @author Atlas
 */
public class contasVenderItens extends javax.swing.JFrame {

    /**
     * Creates new form contasVenderItens
     */
    public contasVenderItens() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contasVenderItens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new contasVenderItens().setVisible(true);
            }
        });
    }
