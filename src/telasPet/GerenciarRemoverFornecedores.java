 ...
 * @author gungnir
 */
public class GerenciarRemoverFornecedores extends javax.swing.JFrame {

    /**
     * Creates new form GerenciarRemoverFornecedores
     */
    public GerenciarRemoverFornecedores() {
        initComponents();
        ...
        table.addMouseListener(
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt
                ...
                if (row >= 0 && col >= 0) {
                    ...
                    if (flag) {
                        controle.InativaFornecedor(listaFornecedor.get(row-1).getId());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Remover Fornecedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarRemoverFornecedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
