 ...
 * @author Atlas
 */
public class GerenciarCadastrarFornecedor extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarCadastrarFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
